...
> I build at both ends of the stack: neural networks on one side, and the bare-metal
> firmware they eventually run on at the other. Most of my public work is reverse
> engineering hardware nobody documented, then writing open firmware for it.

```console
> scan --target dot-agi --field-report

  OPERATING RANGE .... bare-metal firmware  ->  deep learning  ->  quant research
  CURRENT OBSESSION .. open firmware for keyboards nobody else will support
  ...
  ALSO FOUND IN ...... research notebooks, quant coursework, LeetCode at 2am
```
